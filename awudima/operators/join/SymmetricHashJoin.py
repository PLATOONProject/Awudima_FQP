...
from awudima.operators.GJOperatorStructures import NHJTable, NHJRecord
        ...
        while not(tuple1 == "EOF") or not(tuple2 == "EOF"):
            ...
            if not(tuple1 == "EOF"):
                try:
                    ...
                    # print "Tuples in right table",
                    # len(self.right_table.partitions[0].records)
