...
from awudima.operators.GJOperatorStructures import NHJRecord

WINDOW_SIZE = 10


class NestedHashOptionalJoinFilter(Optional):
    ...
    def instantiate(self, d):
        ...
        return NestedHashOptionalJoinFilter(newvars_left, newvars_right)
